...
export interface NewsItem {
  ...
  date: string;
  title: string;
  project_name: string; // Thêm trường này để nhất quán
  clientInformation: string; // Giữ lại trường này
  imageUrl: string;
...
export const newsData: NewsItem[] = [
  { id: 1, date: '2026.04.26', title: 'project 1', project_name: 'Project Alpha', clientInformation: 'Client A', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204801368' },
  { id: 2, date: '2024.03.26', title: 'project 2', project_name: 'Project Beta', clientInformation: 'Client B', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204790802' },
  { id: 3, date: '2026.04.05', title: 'project 3', project_name: 'Project Gamma', clientInformation: 'Client C', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204801368' },
  { id: 4, date: '2024.03.18', title: 'project 4', project_name: 'Project Delta', clientInformation: 'Client D', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204790802' },
  { id: 5, date: '2024.03.10', title: 'project 5', project_name: 'Project Epsilon', clientInformation: 'Client E', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204801368', modelUrl: 'models/Lipstick.glb' },
  { id: 6, date: '2024.02.28', title: 'project 6', project_name: 'Project Zeta', clientInformation: 'Client F', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204790802' },
  { id: 7, date: '2024.02.15', title: 'project 7', project_name: 'Project Eta', clientInformation: 'Client G', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204801368' },
  { id: 8, date: '2024.01.20', title: 'project 8', project_name: 'Project Theta', clientInformation: 'Client H', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204790802' }
];

// Data cho Khách hàng (Our Customers!)
export const customerData: NewsItem[] = [
  { id: 101, date: 'THANK YOU', title: 'project 101', project_name: 'Project Iota', clientInformation: 'Client I', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204801368' },
  { id: 102, date: 'CREATIVE', title: 'project 102', project_name: 'Project Kappa', clientInformation: 'Client K', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204790802' },
  { id: 103, date: 'STUDIO', title: 'project 103', project_name: 'Project Lambda', clientInformation: 'Client L', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204801368' },
  { id: 104, date: 'TRUSTED', title: 'project 104', project_name: 'Project Mu', clientInformation: 'Client M', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204801368' },
  { id: 105, date: '2026', title: 'project 105', project_name: 'Project Nu', clientInformation: 'Client N', imageUrl: 'images/logo_text.png', videoUrl: 'https://vimeo.com/1204801368' }
];
